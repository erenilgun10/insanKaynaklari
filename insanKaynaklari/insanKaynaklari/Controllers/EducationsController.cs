...
namespace insanKaynaklari.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Status,Degree")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Status,Degree")] Education education)
        {
            if (ModelState.IsValid)
            {
